...
/* harmony import */ var _vendor_verbb_formie_src_web_assets_frontend_src_js_formie_lib__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../vendor/verbb/formie/src/web/assets/frontend/src/js/formie-lib */ "./vendor/verbb/formie/src/web/assets/frontend/src/js/formie-lib.js");
// module 
...
function initScript() {
  console.log('initScript() Run'); // sal();
  ...
  var swiperCarousel = new swiper_bundle__WEBPACK_IMPORTED_MODULE_8__["default"]('.js-swiper-carousel', {
    // Optional parameters
    // loop: true,
    // autoHeight: true,
    speed: 300,
  ...
  var swiperSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_8__["default"]('.js-swiper-slider', {
    // Optional parameters
    // loop: true,
    // autoHeight: true,
    speed: 300,
  ...
  var swiperImageSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_8__["default"]('.js-swiper-image-slider', {
    // loop: true,
    // autoHeight: true,
    speed: 300,
    slidesPerView: 1,
  ...
  var swiperProductCarousel = new swiper_bundle__WEBPACK_IMPORTED_MODULE_8__["default"]('.js-swiper-product-carousel', {
    // loop: true,
    spaceBetween: 24,
    // autoHeight: true,
    speed: 300,
  ...
  var swiperSpaCarousel = new swiper_bundle__WEBPACK_IMPORTED_MODULE_8__["default"]('.js-swiper-spa-carousel', {
    // loop: true,
    spaceBetween: 24,
    // autoHeight: true,
    speed: 300,
  ...
  var scroller = scrollama__WEBPACK_IMPORTED_MODULE_4___default()();
  scroller.setup({
    step: ".js-step"
  ...
  window.addEventListener("resize", scroller.resize); // initForms()
...
/***/ "./vendor/verbb/formie/src/web/assets/frontend/src/js/formie-form-base.js":
/*!********************************************************************************!*\
  !*** ./vendor/verbb/formie/src/web/assets/frontend/src/js/formie-form-base.js ***!
  \********************************************************************************/
...
/* harmony import */ var _formie_form_theme__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./formie-form-theme */ "./vendor/verbb/formie/src/web/assets/frontend/src/js/formie-form-theme.js");
...
var globals = __webpack_require__(/*! ./utils/globals */ "./vendor/verbb/formie/src/web/assets/frontend/src/js/utils/globals.js");
...
var FormieFormBase = /*#__PURE__*/function () {
  function FormieFormBase() {
    ...
    this.formId = "#formie-form-".concat(config.formId);
    ...
    this.$form.addEventListener('submit', function (e) {
      e.preventDefault();
      var beforeSubmitEvent = new CustomEvent('onBeforeFormieSubmit', {
        bubbles: true,
        cancelable: true,
        detail: {
          submitHandler: _this
      ...
      setTimeout(function () {
        var validateEvent = new CustomEvent('onFormieValidate', {
          bubbles: true,
          cancelable: true,
          detail: {
            submitHandler: _this
        ...
        if (!_this.$form.dispatchEvent(validateEvent)) {
          return;
        }
  ...
  _createClass(FormieFormBase, [{
    ...
    value: function submitForm() {
      ...
      var submitEvent = new CustomEvent('onFormieSubmit', {
        bubbles: true,
        cancelable: true,
        detail: {
          submitHandler: this
...
/***/ "./vendor/verbb/formie/src/web/assets/frontend/src/js/formie-form-theme.js":
/*!*********************************************************************************!*\
  !*** ./vendor/verbb/formie/src/web/assets/frontend/src/js/formie-form-theme.js ***!
  \*********************************************************************************/
...
/* harmony import */ var _utils_bouncer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/bouncer */ "./vendor/verbb/formie/src/web/assets/frontend/src/js/utils/bouncer.js");
...
var FormieFormTheme = /*#__PURE__*/function () {
  ...
  _createClass(FormieFormTheme, [{
    ...
    value: function initValidator() {
      ...
      this.validator = new _utils_bouncer__WEBPACK_IMPORTED_MODULE_0__["Bouncer"](this.formId, registerFormieValidation.detail.validatorSettings); // Override error messages defined in DOM - Bouncer only uses these as a last resort
      ...
      document.addEventListener('bouncerShowError', function (e) {
        ...
        var message = $field.getAttribute('data-fui-message'); // Check if we need to move the error out of the .fui-input-container node.
    ...
    value: function addSubmitEventListener() {
      ...
      $submitBtns.forEach(function ($submitBtn) {
        $submitBtn.addEventListener('click', function (e) {
          _this.$submitBtn = e.target; // Store for later if we're using text spinner

          _this.originalButtonText = e.target.textContent.trim();
        });
      });
    ...
    value: function beforeSubmit() {
      ...
      Array.prototype.filter.call(this.$form.querySelectorAll('input, select, textarea'), function ($field) {
        _this3.validator.removeError($field);
      });
      ...
      xhr.onreadystatechange = function () {
        ...
        if (xhr.status >= 200 && xhr.status < 300) {
          try {
            ...
            if (response.errors) {
              _this4.onAjaxError(response.errors, response.errorMessage);
            } else {
              _this4.onAjaxSuccess(response);
            }
          } catch (e) {
            _this4.onAjaxError(t('Unable to parse response `{e}`.', {
              e: e
            }));
          }
        } else {
          _this4.onAjaxError(xhr.status + ': ' + xhr.statusText);
        }
      };
    ...
    key: "afterAjaxSubmit",
    value: function afterAjaxSubmit(response) {
    ...
    key: "onAjaxError",
    value: function onAjaxError(response) {
      var _this5 = this;
      ...
      if (_typeof(response) === 'object') {
        Object.keys(response).forEach(function (handle, index) {
          var _response$handle = _slicedToArray(response[handle], 1),
              error = _response$handle[0];

          var $field = document.querySelector("[name=\"fields[".concat(handle, "]\"]"));

          if ($field) {
            _this5.validator.showError($field, {
              customMessage: error
    ...
    value: function onAjaxSuccess(data) {
      ...
      if (this.settings.submitAction === 'message') {
        this.showFormAlert(this.settings.submitActionMessage, 'success'); // Check if we need to remove the success message
    ...
    value: function setCurrentPage(pageId) {
      this.currentPageId = "#formie-p-".concat(pageId);
...
/***/ "./vendor/verbb/formie/src/web/assets/frontend/src/js/formie-lib.js":
/*!**************************************************************************!*\
  !*** ./vendor/verbb/formie/src/web/assets/frontend/src/js/formie-lib.js ***!
  \**************************************************************************/
...
/* harmony import */ var _formie_form_base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./formie-form-base */ "./vendor/verbb/formie/src/web/assets/frontend/src/js/formie-form-base.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var Formie = /*#__PURE__*/function () {
  ...
  _createClass(Formie, [{
    ...
    value: function initForm($form) {
      ...
      var registeredJs = formConfig.registeredJs || []; // Create the form class, save it to our collection

      var form = new _formie_form_base__WEBPACK_IMPORTED_MODULE_0__["FormieFormBase"](formConfig);
      this.forms.push(form); // Is there any additional JS config registered for this form?
      ...
      if (registeredJs.length) {
        ...
        registeredJs.forEach(function (config) {
          ...
          if (config.src) {
            ...
            $script.defer = true; // Parse any JS onload code we have. Yes, I'm aware of `eval()` but its pretty safe as it's
...
/***/ "./vendor/verbb/formie/src/web/assets/frontend/src/js/utils/bouncer.js":
/*!*****************************************************************************!*\
  !*** ./vendor/verbb/formie/src/web/assets/frontend/src/js/utils/bouncer.js ***!
  \*****************************************************************************/
...
/***/ "./vendor/verbb/formie/src/web/assets/frontend/src/js/utils/globals.js":
/*!*****************************************************************************!*\
  !*** ./vendor/verbb/formie/src/web/assets/frontend/src/js/utils/globals.js ***!
  \*****************************************************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function(global) {global.t = function (string) {
...
__webpack_require__(/*! /Users/chanwhab/Sites/asiaspa/src/js/app.js */"./src/js/app.js");
module.exports = __webpack_require__(/*! /Users/chanwhab/Sites/asiaspa/src/scss/app.scss */"./src/scss/app.scss");
